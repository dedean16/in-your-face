...
\author{Author 1 name,~\IEEEmembership{email address,~student id,~educational program}
...
% The paper headers
\markboth{insert date here, followed by the name of course}%
...
\begin{abstract}
%\boldmath
Add a short abstract here containing at most 100 words. Abstracts do not contain symbols, special characters, math, or references. Describe the context shortly, and summarize the research question and the main items from the discussion.
\end{abstract}
...
\IEEEPARstart{T}{he} introduction contains (1) a background, (2) the definition of the problem that is addressed possibly with a research question and subquestions, (3) a short outline of the report.
...
A short inventory of what has been used.
