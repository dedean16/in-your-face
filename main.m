...
facemesh(disparmap_R.* mask_Mr_rec) 
facemesh(disparmap_L.* mask_Ml_rec) 


%%
disparmap_R(isnan(disparmap_R)) = 0;
disparmap_R(mask_Mr_rec==1 & disparmap_R==0) = -1;
disparmap_f = relaxgaps(disparmap_R.*mask_Mr_rec,-1,1,300,0.001,0);
